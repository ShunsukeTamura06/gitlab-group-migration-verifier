...
- 配布担当者が作成した`gitlab-group-migrator-internal-v1.3.1-*.zip`
- 配布ZIPの`.sha256`ファイル
...
v1.3.0で失敗してv1.3.1へ更新する場合は、旧フォルダーを削除せず、新しい展開フォルダーへ旧フォルダーの`work`フォルダー全体をコピーしてから起動します。ManifestやExport Archiveを個別に編集しないでください。
